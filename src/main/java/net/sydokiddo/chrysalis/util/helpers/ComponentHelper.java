...
public class ComponentHelper {
    ...
    public static final MutableComponent
        ...
        WATER_ICON = Component.translatable("gui.icon.chrysalis.water"),
        LAVA_ICON = Component.translatable("gui.icon.chrysalis.lava"),
        FLOWSLUDGE_ICON = Component.translatable("gui.icon.chrysalis.flowsludge"),
        MOLTEN_VOID_ICON = Component.translatable("gui.icon.chrysalis.molten_void"),
        ECTOPLASM_ICON = Component.translatable("gui.icon.chrysalis.ectoplasm"),
        BIOMIRE_ICON = Component.translatable("gui.icon.chrysalis.biomire"),
        REMAINS_ON_DEATH_ICON = Component.translatable("gui.icon.chrysalis.remains_on_death"),
        VIBRATION_ICON = Component.translatable("gui.icon.chrysalis.vibration"),
        MUFFLED_ICON = Component.translatable("gui.icon.chrysalis.muffled"),
        MUSIC_NOTE_ICON = Component.translatable("gui.icon.chrysalis.music_note"),
