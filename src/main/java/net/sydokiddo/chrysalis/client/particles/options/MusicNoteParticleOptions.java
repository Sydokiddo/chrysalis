...
public class MusicNoteParticleOptions extends ScalableParticleOptionsBase implements ParticleCommonMethods {

    /**
     * The options class for music note particles.
     **/

    public static final MapCodec<MusicNoteParticleOptions> CODEC = RecordCodecBuilder.mapCodec((instance) ->
    ...
    .apply(instance, MusicNoteParticleOptions::new));

    public static final StreamCodec<RegistryFriendlyByteBuf, MusicNoteParticleOptions> STREAM_CODEC = StreamCodec.composite(
    ...
    public @NotNull ParticleType<?> getType() {
        return CParticles.MUSIC_NOTE.get();
    }
}