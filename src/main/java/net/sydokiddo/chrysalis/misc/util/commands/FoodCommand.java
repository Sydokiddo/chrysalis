...
public class FoodCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((Commands.literal("food").requires((commandSourceStack) -> commandSourceStack.hasPermission(2))

        .then(Commands.literal("add").then((Commands.argument(targetString, EntityArgument.player())
        .then(Commands.argument(nutritionAmountString, IntegerArgumentType.integer(1)).then(Commands.argument(saturationAmountString, FloatArgumentType.floatArg(1))
        ...
        .then(Commands.literal("remove").then((Commands.argument(targetString, EntityArgument.player())
        .then(Commands.argument(nutritionAmountString, IntegerArgumentType.integer(1)).then(Commands.argument(saturationAmountString, FloatArgumentType.floatArg(1))
        ...
        .then(Commands.literal("set").then((Commands.argument(targetString, EntityArgument.player())
        .then(Commands.argument(nutritionAmountString, IntegerArgumentType.integer()).then(Commands.argument(saturationAmountString, FloatArgumentType.floatArg())
