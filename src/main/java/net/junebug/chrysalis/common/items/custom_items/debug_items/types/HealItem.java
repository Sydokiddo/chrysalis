    ...
    public @NotNull InteractionResult use(@NotNull Level level, Player player, @NotNull InteractionHand interactionHand) {
        ...
        if (player.getHealth() < player.getMaxHealth()) {
            ...
            if (!level.isClientSide() && player instanceof ServerPlayer serverPlayer) {
                ...
                EntityHelper.playItemUseNotifySound(serverPlayer, CSoundEvents.HEAL_USE.get());
                ParticleHelper.emitParticlesAroundEntity(serverPlayer, ParticleTypes.HEART, 1.0D, 10);
