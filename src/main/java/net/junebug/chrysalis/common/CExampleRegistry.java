...
import net.junebug.chrysalis.client.particles.options.*;
import net.junebug.chrysalis.common.blocks.custom_blocks.examples_and_testing.*;
...
import net.junebug.chrysalis.common.items.custom_items.examples_and_testing.ExampleBowItem;
import net.junebug.chrysalis.common.misc.CTags;
import net.junebug.chrysalis.util.blocks.dispensers.PlaceBlockDispenserBehavior;
import net.junebug.chrysalis.util.blocks.dispensers.PlaceEntityDispenserBehavior;
import net.junebug.chrysalis.util.blocks.dispensers.ShootProjectileDispenserBehavior;
...
import net.junebug.chrysalis.common.items.custom_items.*;
...
public class CExampleRegistry {
    ...
    private static final DustCloudParticleOptions EXAMPLE_DUST_CLOUD_PARTICLES = new DustCloudParticleOptions(ComponentHelper.VOID_FIRE_COLOR.getRGB(), true, true);
