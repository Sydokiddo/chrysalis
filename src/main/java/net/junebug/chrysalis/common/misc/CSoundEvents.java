...
public class CSoundEvents {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent>
        ...
        PICK_UP_MOB_USE = SOUND_EVENTS.register("item.pick_up_mob.use", SoundEvent::createVariableRangeEvent),
        ...
        KEY_GOLEM_NOVELTY = SOUND_EVENTS.register("entity.key_golem.novelty", SoundEvent::createVariableRangeEvent),
        KEY_GOLEM_STEP = SOUND_EVENTS.register("entity.key_golem.step", SoundEvent::createVariableRangeEvent),
        KEY_GOLEM_HURT = SOUND_EVENTS.register("entity.key_golem.hurt", SoundEvent::createVariableRangeEvent),
        KEY_GOLEM_DEATH = SOUND_EVENTS.register("entity.key_golem.death", SoundEvent::createVariableRangeEvent),
        KEY_GOLEM_FALL_ASLEEP = SOUND_EVENTS.register("entity.key_golem.fall_asleep", SoundEvent::createVariableRangeEvent),
        ...
        KEY_GOLEM_DROP = SOUND_EVENTS.register("entity.key_golem.drop", SoundEvent::createVariableRangeEvent),
        KEY_GOLEM_DISAPPEAR = SOUND_EVENTS.register("entity.key_golem.disappear", SoundEvent::createVariableRangeEvent),
        ...
        KEY_GOLEM_BRIGHTEN = SOUND_EVENTS.register("entity.key_golem.brighten", SoundEvent::createVariableRangeEvent),
        ...
        KEY_GOLEM_ADD_PLAYER_EFFECT = SOUND_EVENTS.register("entity.key_golem.add_player_effect", SoundEvent::createVariableRangeEvent),
        KEY_GOLEM_REMOVE_PLAYER_EFFECT = SOUND_EVENTS.register("entity.key_golem.remove_player_effect", SoundEvent::createVariableRangeEvent),
